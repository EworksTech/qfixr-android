	...
	public void onCreate(Bundle savedInstanceState) {
		...
		lv1.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> a, View v, int position, long id) {
				...
				Intent intent = new Intent(MyNotifications.this, MyNotificationsItem.class);
				MyNotifications.this.startActivity(intent);
 ...
 @Override
   public void onBackPressed() {
	...
	private ArrayList<NewCallsObject> getListData() {
		...
		newsData.setDefect("Chamados em Aberto");
		newsData.setAddress("Você nao fechou chamaos em aberto");
		newsData.setCallId("100");
		results.add(newsData);
		
		newsData = new NewCallsObject();
		newsData.setDefect("Ausência");
		newsData.setAddress("Faz mais de 10 dias desde seu ultimo...");
		newsData.setCallId("100");
		results.add(newsData);
		newsData = new NewCallsObject();
		newsData.setDefect("Chamados em Aberto");
